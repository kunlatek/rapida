...
import { ANIMATION } from "../rapida-clients/example/animation/animation";
import { ANIMATION_FORM } from "../rapida-clients/example/animation/animation-form";
import { ANIMATION_TABLE } from "../rapida-clients/example/animation/animation-table";


import { CHARACTER } from "../rapida-clients/example/animation/character";
import { CHARACTER_FORM } from "../rapida-clients/example/animation/character-form";
import { CHARACTER_TABLE } from "../rapida-clients/example/animation/character-table";
