    ...
    elements: [
      {
        tabs: [
            ...
            elements: [
              ...
              },
              {
                input: {
                  ...
                  placeholder: "Ex.: É uma corporação transnacional sul-coreana que atua em diversos ramos da área da tecnologia da informação com sede em Seul, capital da Coreia do Sul.",
                  tooltip: "Descrição da empresa que fabrica produtos",
                }
              },
            ]
          },
          {
            id: "contactsTab",
            title: "Contatos para assistência",
            elements: [
              {
                array: {
                  title: "Contato",
          ...
          {
            title: "Endereços para assistência",
            id: "addressesTab",
            elements: [
              {
                array: {
